...
class PortfolioSnapshotCommand(Command):
    ...
    def _generate_portfolio_snapshot(self, cli, portfolio_id: int, portfolio: Dict, progress, task) -> Dict[str, Any]:
        """
                        ...
                        try:
                            ...
                            if not rsi_result.empty:
                                ...
                                tech_analysis["rsi"] = {
                                    ...
                                    "status": "Overbought" if latest_rsi['rsi'] > 70 else "Oversold" if latest_rsi['rsi'] < 30 else "Neutral"
                                }
                        except Exception as e:
