            ...
            try:
                ...
                for match in matches:
                    ...
                    for i in range(max(0, line_num - 5), min(len(lines), line_num + 2)):
                        if 'if' in lines[i] and 'current_connection' in lines[i] and ('is not None' in lines[i] or '!= None' in lines[i]):
                            has_check = True
                            break
            ...
            try:
                ...
                for match in matches:
                    ...
                    for i in range(max(0, line_num - 5), min(len(lines), line_num)):
                        if 'if' in lines[i] and 'connection' in lines[i] and ('is not None' in lines[i] or '!= None' in lines[i]):
                            has_check = True
                            break
