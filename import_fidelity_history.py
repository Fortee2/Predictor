...
def import_transactions_from_csv(portfolio_id, csv_filepath):
    ...
    try:
        with open(csv_filepath, mode='r', encoding='utf-8') as file:
            ...
            required_cols = ['Run Date', 'Action', 'Symbol', 'Quantity', 'Price ($)', 'Amount ($)', 'Type']
            ...
            for row in reversed(transaction_data):
                ...
                try:
                    ...
                    if "YOU BOUGHT" in action:
                        ...
                        # As clarified: REINVESTMENT is a 'buy' operation.
                    ...
                    print(f"Column index error in row: {row}. Ensure all expected columns are present. Error: {ie}. Skipping.")
...
if __name__ == '__main__':
    ...
    csv_file_path = 'Accounts_History.csv' 
    ...
    print("Consider running 'python portfolio_cli.py recalculate-history <portfolio_id>' after import to update historical values.")