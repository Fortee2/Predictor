...
class ComprehensivePerformanceFormatter:
    ...
    def create_portfolio_summary_table(self, portfolio_metrics: Dict, portfolio_name: str) -> Table:
        ...
        metrics_config = [
            ...
            ('Annualized Return', 'annualized_return_pct', self.format_percentage, True),
    ...
    def display_comprehensive_analysis(self, 
        ...
        self.console.print(f"COMPREHENSIVE PORTFOLIO ANALYSIS", style="bold blue", justify="center")
        self.console.print("=" * 100, style="bold blue")
        self.console.print("\n")
        ...
        self.console.print("=" * 100, style="bold blue")
        self.console.print("Analysis complete. Data as of:", date.today().strftime("%Y-%m-%d"), style="italic")
        self.console.print("=" * 100, style="bold blue")
