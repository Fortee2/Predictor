    ...
    try:
        ...
        if high_prices:
            ...
            for trans in high_prices:
                print(
                    f"  {trans['transaction_date']} - {trans['ticker']}: ${trans['price']:.2f} "
        ...
        if large_volumes:
            ...
            for vol in large_volumes:
                ...
                print(
                    f"  {vol['transaction_date']}: ${total_vol:,.2f} "
        ...
        if focus_date:
            ...
            if focus_transactions:
                ...
                for trans in focus_transactions:
                    ...
                    print(
                        f"  {trans['transaction_date']} - {trans['transaction_type']} {symbol}: "
        ...
        if cursor.fetchone()["count"] > 0:
            ...
            if large_cash:
                ...
                for cash in large_cash:
                    print(
                        f"  {cash['transaction_date']} - {cash['transaction_type']}: "
